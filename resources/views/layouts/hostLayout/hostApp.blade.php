                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right notification-dropdown">
                                ...
                                <li>
                                    <div class="list-footer" style="font-weight:normal;"> <a href="{{ url('host/chat') }}">View all messages</a></div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown notification">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right notification-dropdown">
                                ...
                                <li>
                                    <div class="list-footer" style="font-weight:normal;"> <a href="{{ url('host/all-notifications') }}">View all notifications</a></div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{ url('/host/profile') }}"><i class="fas fa-user mr-2"></i>Profile</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('host/dashboard') ? 'active' : '' }}" href="{{ url('host/dashboard') }}"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('host/listings') ? 'active' : '' }}" href="{{ url('host/listings') }}"><i class="fa fa-fw fa-list-alt"></i>Listings</a>
                            </li>

                            <li class="nav-item">
                              <a class="nav-link collapsed {{ (Request::is('host/bookings/booking-calendar') || Request::is('host/bookings/booking-list')) ? 'active' : '' }}" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fas fa-fw fa-shopping-cart"></i>Bookings</a>
                              <div id="submenu-1" class="submenu collapse" style="">
                                  <ul class="nav flex-column">
                                      <li class="nav-item">
                                          <a class="nav-link" href="{{ url('host/bookings/booking-calendar') }}">Booking Calendar</a>
                                      </li>
                                      <li class="nav-item">
                                          <a class="nav-link" href="{{ url('host/bookings/booking-list') }}">Booking List</a>
                                      </li>
                                  </ul>
                              </div>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('host/chat') ? 'active' : '' }}" href="{{ url('host/chat') }}"><i class="fab fa-fw fas fa-comments"></i>Messages
                                  @if($unreadCount != 0)
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('host/change-password') ? 'active' : '' }}" href="{{ url('host/change-password') }}"><i class="fas fa-fw fa-unlock"></i>Change Password</a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(document).on("click", "#get_unread_conversations", function(){
          $.ajax({
            'url'      : '{{ url("host/get-unread-conversations") }}',
            'method'   : 'get',
            'dataType' : 'json',
