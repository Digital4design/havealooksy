                ...
                <div class="menu float-right col-lg-3">
                   <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav" style="display:flex;float:right;"> 
                      <li class="dropdown notifications-menu" style="margin-left:0px;">
                        ...
                        <ul class="dropdown-menu" style="padding:5px;padding-bottom:0px;color:#fff;width:240px;font-size:12px;">
                          ...
                          <li class="footer"><a class="text-center" id="view_all_notifications" href="{{ url('host/all-notifications') }}">View all</a></li>
                        </ul>
                      </li>
                      <li id="hoverable"><a class="user_name text-center">{{ Auth::user()->first_name }}</a></li>
                      <ul class="dropdown-items">
                          <li class="dropdown-item"><a href="{{ url('host/dashboard') }}">Dashboard</a></li>
