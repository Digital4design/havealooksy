...
<body>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right notification-dropdown">
                                ...
                                <li>
                                    <div class="list-footer" style="font-weight:normal;"> <a href="{{ url('shopper/chat') }}">View all messages</a></div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown notification">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right notification-dropdown">
                                ...
                                <li>
                                    <div class="list-footer" style="font-weight:normal;"> <a href="{{ url('shopper/all-notifications') }}">View all notifications</a></div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{ url('/shopper/profile') }}"><i class="fas fa-user mr-2"></i>Profile</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('shopper/dashboard') ? 'active' : '' }}" href="{{ url('shopper/dashboard') }}"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('shopper/bookings') ? 'active' : '' }}" href="{{ url('shopper/bookings') }}"><i class="fa fa-fw fa-shopping-cart"></i>Bookings</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('shopper/ratings') ? 'active' : '' }}" href="{{ url('shopper/ratings') }}"><i class="fas fa-fw fa-star"></i>Rate Your Experience</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('shopper/chat') ? 'active' : '' }}" href="{{ url('shopper/chat') }}"><i class="fab fa-fw fas fa-comments"></i>Messages
                                  @if($unreadCount != 0)
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('shopper/change-password') ? 'active' : '' }}" href="{{ url('shopper/change-password') }}"><i class="fas fa-fw fa-unlock"></i>Change Password</a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $(".notification-list").css('min-height', '0px');
