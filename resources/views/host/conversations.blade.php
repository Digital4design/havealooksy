                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="pull-right mb-2">
                          <button id="new-conversation-button" type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#start-new-conversation"><i class="fas fa-fw fa-envelope"></i>&nbsp;&nbsp;Message Admin</button>
                        </div>
                    </nav>
                </div>
            </div>
                  ...
                  @if(!$conversations->isEmpty())
                    @foreach($conversations as $val)
                      <div class="small-box conv" style="margin-bottom:10px;border-radius:5px;box-shadow:1px 1px 5px #ccc;">
                          <a href="{{ url('host/chat/get-chat/'.$val['user']['id']) }}" class="inner conv_link" style="padding:5px;">
