            ...
            <form class="form-horizontal" method="POST" action="{{ url('/admin/listings/update-listing') }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input id="people_count" name="people_count" type="number" class="form-control" placeholder="People Count" value="{{ $errors->has('people_count') ? old('people_count') : $listing_data['getGuests']['total_count'] }}">
